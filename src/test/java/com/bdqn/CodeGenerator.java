...
public class CodeGenerator {
    ...
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://120.24.98.130:3306/erp?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="z123456z";//数据库密码
